...
/**
 * \file    test/phpunit/WhatsappFunctionalTest.php
 * \ingroup whatsapp
 ...
 *
 * @package Testwhatsapp
 */
class WhatsappFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/whatsapp/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('whatsapp/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/whatsapp/admin/about.php');
		$this->authenticate();
		return $this->assertContains('whatsapp/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('whatsappwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modWhatsapp_WhatsappTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modWhatsapp_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
