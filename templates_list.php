...
/**
 *   	\file       templates_list.php
 *		\ingroup    whatsapp
 *		\brief      List page for templates
 */
...
require_once __DIR__ . '/class/templates.class.php';
...
$hookmanager->initHooks(array('templateslist')); // Note that conf->hooks_modules contains array
...
$permissiontoadd = $user->rights->whatsapp->templates->write;
...
//$help_url = "EN:Module_Templates|FR:Module_Templates_FR|ES:Módulo_Templates";
$help_url = '';
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: " . dol_buildpath('/whatsapp/templates_card.php', 1) . '?id=' . $id);
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/whatsapp/templates_card.php', 1) . '?action=create&backtopage=' . urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_' . $object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendTemplatesRef";
$modelmail = "templates";
$objecttmp = new Templates($db);
