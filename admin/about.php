...
print dol_get_fiche_head($head, 'about', $langs->trans($page_name), 0, 'whatsapp@whatsapp');

dol_include_once('/whatsapp/core/modules/modWhatsapp.class.php');
$tmpmodule = new modWhatsapp($db);
